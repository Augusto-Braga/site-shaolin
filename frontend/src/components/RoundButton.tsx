...
function RoundButton(props: ITransparentButtonProps) {
  ...
  const classNames = `${styleButton} border-2 border-white pt-3 pb-3 pr-9 pl-9 rounded-full
   hover:bg-shaolinRed hover:text-black hover:border-none duration-300`;
